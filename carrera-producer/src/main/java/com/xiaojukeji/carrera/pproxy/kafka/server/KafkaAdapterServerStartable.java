...
public class KafkaAdapterServerStartable {
    ...
    public KafkaAdapterServerStartable(KafkaConfig kafkaConfig, ProducerPool producerPool, ProducerAsyncServerImpl serverImpl, ConfigManager configManager) {
        kafkaAdapterServer = new KafkaAdapterServer(kafkaConfig,producerPool,serverImpl, configManager);
    }
