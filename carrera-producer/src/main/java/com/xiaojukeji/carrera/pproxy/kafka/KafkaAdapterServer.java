...
public class KafkaAdapterServer {
    ...
    public KafkaAdapterServer(KafkaConfig kafkaConfig, ProducerPool producerPool, ProducerAsyncServerImpl serverImpl, ConfigManager configManager) {
    ...
    public void startup() {
        ...
        KafkaApis apis = new KafkaApis(socketServer.getRequestChannel(), producerPool, serverImpl, configManager);
