...
public class KafkaServer implements Server{
    ...
    public KafkaServer(ProducerPool producerPool, ProducerAsyncServerImpl serverImpl, ConfigManager configManager) {
        KafkaConfig kafkaConfig = new KafkaConfig();
        kafkaAdapterServerStartable = new KafkaAdapterServerStartable(kafkaConfig, producerPool, serverImpl, configManager);
    }
